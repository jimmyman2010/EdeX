...
function edexScripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('jquery', get_template_directory_uri() . '/js/lib.min.js', array(), EDEX_VERSION);

        wp_register_script('pluginsscript', get_template_directory_uri() . '/js/plugins.min.js', array(), EDEX_VERSION, true);
        wp_enqueue_script('pluginsscript'); // Enqueue it!

        wp_register_script('edexscript', get_template_directory_uri() . '/js/global.min.js', array(), EDEX_VERSION, true);
...
function edexStyles()
{
    wp_register_style('pluginscss', get_template_directory_uri() . '/css/plugins.min.css', array(), EDEX_VERSION, 'all');
    wp_enqueue_style('pluginscss'); // Enqueue it!

    wp_register_style('globalcss', get_template_directory_uri() . '/css/global.min.css', array(), EDEX_VERSION, 'all');
    wp_enqueue_style('globalcss'); // Enqueue it!

    wp_register_style('edexcss', get_template_directory_uri() . '/style.css', array(), EDEX_VERSION, 'all');
