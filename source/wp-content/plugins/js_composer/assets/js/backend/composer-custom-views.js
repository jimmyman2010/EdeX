...
(function ($) {
    ...
    window.VcWheelView = vc.shortcode_view.extend({
        adding_new_piece:false,
        events:{
            'click .add_tab':'addTab',
            'click > .vc_controls .column_delete, > .vc_controls .vc_control-btn-delete':'deleteShortcode',
            'click > .vc_controls .column_edit, > .vc_controls .vc_control-btn-edit':'editElement',
        ...
        render:function () {
            window.VcWheelView.__super__.render.call(this);
            this.$content.sortable({
                axis:"y",
                handle:"h3",
                stop:function (event, ui) {
        ...
        changeShortcodeParams:function (model) {
            window.VcWheelView.__super__.changeShortcodeParams.call(this, model);
            var collapsible = _.isString(this.model.get('params').collapsible) && this.model.get('params').collapsible === 'yes' ? true : false;
            if (this.$content.hasClass('ui-accordion')) {
                this.$content.accordion("option", "collapsible", collapsible);
            }
        ...
        changedContent:function (view) {
            ...
            this.$content.accordion({
                ...
                heightStyle: "content",
                collapsible:collapsible,
                active:this.adding_new_piece === false && view.model.get('cloned') !== true ? 0 : view.$el.index()
            });
            this.adding_new_piece = false;
        },
        addTab:function (e) {
            this.adding_new_piece = true;
            e.preventDefault();
            vc.shortcodes.create({shortcode:'vc_wheel_piece', params:{title:'Piece'}, parent_id:this.model.id});
        },
        _loadDefaults:function () {
            window.VcWheelView.__super__._loadDefaults.call(this);
        }
    });

    window.VcWheelPieceView = window.VcColumnView.extend({
        events:{
            'click > .vc_controls .column_delete,.wpb_vc_wheel_piece > .vc_controls .vc_control-btn-delete':'deleteShortcode',
            'click > .vc_controls .column_add,.wpb_vc_wheel_piece >  .vc_controls .vc_control-btn-prepend':'addElement',
            'click > .vc_controls .column_edit,.wpb_vc_wheel_piece >  .vc_controls .vc_control-btn-edit':'editElement',
            'click > .vc_controls .column_clone,.wpb_vc_wheel_piece > .vc_controls .vc_control-btn-clone':'clone',
            'click > [data-element_type] > .wpb_element_wrapper > .vc_empty-container':'addToEmpty'
        },
        setContent:function () {
            this.$content = this.$el.find('> [data-element_type] > .wpb_element_wrapper > .vc_container_for_children');
        ...
        changeShortcodeParams:function (model) {
            var params = model.get('params');
            window.VcWheelPieceView.__super__.changeShortcodeParams.call(this, model);
            if (_.isObject(params) && _.isString(params.title)) {
                this.$el.find('> h3 .tab-label').text(params.title);
            }
        },
    ...
    window.VcContentSliderView = vc.shortcode_view.extend({
        ...
        changeShortcodeParams:function (model) {
            window.VcContentSliderView.__super__.changeShortcodeParams.call(this, model);
            var collapsible = _.isString(this.model.get('params').collapsible) && this.model.get('params').collapsible === 'yes' ? true : false;
            if (this.$content.hasClass('ui-accordion')) {
                this.$content.accordion("option", "collapsible", collapsible);
            }
        ...
        changedContent:function (view) {
            ...
            this.adding_new_item = false;
        },
        addTab:function (e) {
            this.adding_new_item = true;
            e.preventDefault();
            vc.shortcodes.create({shortcode:'vc_content_item', params:{title:'Item'}, parent_id:this.model.id});
        },
        _loadDefaults:function () {
            window.VcContentSliderView.__super__._loadDefaults.call(this);
        }
    });

    window.VcContentItemView = window.VcColumnView.extend({
        events:{
            'click > .vc_controls .column_delete,.wpb_vc_content_item > .vc_controls .vc_control-btn-delete':'deleteShortcode',
            'click > .vc_controls .column_add,.wpb_vc_content_item >  .vc_controls .vc_control-btn-prepend':'addElement',
            'click > .vc_controls .column_edit,.wpb_vc_content_item >  .vc_controls .vc_control-btn-edit':'editElement',
            'click > .vc_controls .column_clone,.wpb_vc_content_item > .vc_controls .vc_control-btn-clone':'clone',
            'click > [data-element_type] > .wpb_element_wrapper > .vc_empty-container':'addToEmpty'
        },
        setContent:function () {
            this.$content = this.$el.find('> [data-element_type] > .wpb_element_wrapper > .vc_container_for_children');
        ...
        changeShortcodeParams:function (model) {
            var params = model.get('params');
            window.VcContentItemView.__super__.changeShortcodeParams.call(this, model);
            if (_.isObject(params) && _.isString(params.title)) {
                this.$el.find('> h3 .tab-label').text(params.title);
            }
        },
